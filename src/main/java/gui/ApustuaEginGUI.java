...
public class ApustuaEginGUI extends JFrame{
	...
	private static final String e = "Etiquetas";
	private JLabel jLabelListOfEvents = new JLabel(ResourceBundle.getBundle(e).getString("ListEvents"));
	private JLabel jLabelEventDate = new JLabel(ResourceBundle.getBundle(e).getString("EventDate"));
	private JCalendar jCalendar = new JCalendar();
	private Calendar calendarAct = null;
	private Calendar calendarAnt = null;

	private JScrollPane scrollPaneEvents = new JScrollPane();
	private JButton jButtonClose = new JButton(ResourceBundle.getBundle(e).getString("Close"));
